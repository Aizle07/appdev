          ...
          <div class="navbar-end">
            ...
            <div class="navbar-item dropdown has-divider has-user-avatar">
              <a class="navbar-link">
                ...
                <div class="is-user-name"><span>{{vendors.vendor_name}}</span></div>
        ...
        <div class="container mx-auto">
            ...
            <div class="w-full md:w-8/12">
                ...
                <form @submit.prevent="addProduct">
                    ...
                    <input v-model="product_name" type="text" id="product_name" class="mt-1 p-2 w-full border rounded-md">
                    </div>
                    <div class="mb-4">
                    <label for="prod_image" class="block text-sm font-medium text-gray-600">Product Image</label>
                    <input @change="handleImageChange" type="file" id="prod_image" class="mt-1 p-2 w-full border rounded-md">
                    </div>
                    <div class="mb-4">
                    ...
                    <button type="submit" class="bg-blue-500 text-white p-2 rounded-md">Add Product</button>
                </form>
                </div>
            </div>
            </div>
